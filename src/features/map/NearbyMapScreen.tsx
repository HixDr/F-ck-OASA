...
import { useClosestStops } from '../../hooks';
...
import { getStopArrivals, getRoutesForStop, getWalkingRoute } from '../../services/api';
import { getLocation } from '../../services/location';
import { getStamps, addStamp, removeStamp, getToggle, setToggle, isFavoriteStop, addFavoriteStop, removeFavoriteStop, getCachedRoutesForStop, setCachedRoutesForStop } from '../../services/storage';
...
import { buildLineGroups, getArrivalColor } from './mapUtils';
...
export default function NearbyMapScreen() {
  ...
  const stopTracking = useMarkerTracking([parsedStops, primaryColor]);
